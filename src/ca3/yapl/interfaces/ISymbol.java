...
/**
 * Interface to YAPL symbols contained in the symbol table. A symbol's data type
 * is represented by an abstract class
 * <code>Type</code>, which needs to be defined before using this interface.
 *
 * @author Mario Taschwer
 * @version $Id: Symbol.java 237 2012-04-12 12:43:30Z mt $
 * @see Symboltable
 */
public interface ISymbol {
    ...
    /**
     * Return
     * <code>true</code> iff this symbol represents a formal parameter passed by
     * reference.
     *
     * @see #setReference()
     */
    ...
    /**
     * Return
     * <code>true</code> iff this symbol belongs to a global scope. That is, its
     * value is stored in heap memory if applicable.
     *
     * @see #getOffset()
     */
     ...
     *
     * @return
     * <code>null</code> if there is no symbol linked to this one.
     */
    ...
    /**
     * Procedure symbol: return
     * <code>true</code> iff the parser has encountered a Return statement
     * within the procedure's body.
     */
