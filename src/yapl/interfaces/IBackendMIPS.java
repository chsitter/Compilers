 ...
 * machine. <p> Address offsets are relative to a certain base address (in the
 * current stack frame or in the static data area) which is determined and hided
 * by the implementation of this interface. Memory locations are always
 * byte-addressed. </p> <p> The machine word size is implementation-dependent
 * and can be determined using the {@link #wordSize()} method. </p> <p> Boolean
 * register values are to be interpreted according to
 * {@link #boolValue(boolean)}, which hides the actual numeric value within the
 * implementation of this interface. </p> <p> Arrays may be allocated at
 * run-time using the
 ...
 * by a recursive procedure in the run-time environment. </p>
 *
 * @author Mario Taschwer
 * @version $Id: BackendAsmRM.java 167 2011-05-10 10:25:55Z mt $
 */
public interface IBackendMIPS {
    /*
     ...
     * @param comment	the comment, may be
     * <code>null</code>.
     */
     ...
     */
    /**
     * Allocate space in static data area. The allocated space will be
     * word-aligned.
     *
     * @param bytes number of bytes to allocate space for.
     * @param comment an inline comment to be emitted when generating assembler
     * code (may be
     * <code>null</code>).
     * @return the offset of the lowest address of the allocated static data
     * area.
     */
    public int allocStaticData(int bytes, String comment);

    /**
     * Allocate string constant in static data area. The string constant will be
    ...
    /**
     * Allocate space on the stack. The allocated space will be word-aligned.
     *
     * @param bytes number of bytes to be allocated.
     * @param comment an inline comment to be emitted when generating assembler
     * code (may be
     * <code>null</code>).
     * @return the offset of the lowest address of the allocated stack area.
     */
     ...
     */
    /**
     * Allocate (one- or multi-dimensional) array at run time. Only word-sized
     ...
     */
    /**
     * Issue a <em>load constant</em> (aka <em>load immediate</em>) instruction.
     *
    ...
    /**
     * Issue a <em>load address</em> instruction using an offset address. The
     * memory address corresponding to the location given by
     * <code>addr</code> will be loaded into the destination register.
     *
     * @param reg the destination register.
     * @param addr the memory offset address.
     * @param isStatic if
     * <code>true</code>,
     * <code>addr</code> is relative to the static data area; otherwise, it is
     ...
     * <code>regDest = regX + regY</code><br> The destination register may be
     * equal to one of the source registers.
     *
     * @param regDest	destination register number.
     ...
     */
    /**
     * Set boolean register value by
     * <code>less than</code> comparison.<br>
     * <code>regDest = (regX &lt; regY)</code><br> The destination register may
    ...
    /**
     * Set boolean register value by
     * <code>less than or equal</code> comparison.<br>
     * <code>regDest = (regX &lt;= regY)</code><br> The destination register may
     * be equal to one of the source registers.
     *
     * @param regDest	destination register number.
    ...
    /**
     * Set boolean register value by
     * <code>is equal</code> comparison.<br>
     * <code>regDest = (regX == regY)</code><br> The destination register may be
     * equal to one of the source registers.
     *
     * @param regDest	destination register number.
     ...
     * <code>regDest = NOT regSrc</code><br> The destination register may be
     * equal to the source register.
     *
     * @param regDest	destination register number.
     ...
     * <code>regDest = regX AND regY</code><br> The destination register may be
     * equal to one of the source registers.
     *
     * @param regDest	destination register number.
     * @param regX	register number of first source operand.
     ...
     * <code>regDest = regX OR regY</code><br> The destination register may be
     * equal to one of the source registers.
     *
     * @param regDest	destination register number.
     * @param regX	register number of first source operand.
     ...
     */
    /**
     * Emit branch instruction jumping to
     * <code>label</code> if a register represents a given boolean value.
     *
     * @param reg	the register representing a boolean value.
     * @param value	the boolean value to compare with
     * <code>reg</code>.
     ...
     */
    /**
     * Generate the main program's prolog. An assembler label suitable as the
     * main program entry point will be chosen by the implemenation.
     */
    ...
    /**
     * Generate a procedure's epilog and return to the caller. Releases the
     ...
     *
     * @param label the procedure epilog label; must match the label given to {@link #exitProc(String)}.
     * @param reg the register holding the return value. Set this to -1 if the
     * procedure does not return a value.
     */
    public void returnFromProc(String label, byte reg);

    /**
     * Prepare stack frame for procedure call. DO NOT allocate space on the
     * stack between calling this method and calling {@link #callProc(byte, String)}.
     *
    ...
    /**
     * Pass an argument residing in a register to a procedure. Needs to be
     * called after {@link #prepareProcCall(int)}.
     *
     * @param arg the argument number, starting at 0.
     * @param reg the register number where the argument value resides.
     */
    public void passArg(int arg, byte reg);

    /**
     * Generate a procedure call.
     * {@link #prepareProcCall(int)} MUST be called before. Procedure arguments
     * (if any) need to be passed using
     * {@link #passArg(int, byte)} before.
     *
     * @param reg register number for storing the return value. Set this
     * parameter to -1, if the procedure does not return a value.
     * @param name the procedure name (label); must match the label given to {@link #enterProc(String, boolean)}.
     */
